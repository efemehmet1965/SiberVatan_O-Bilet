    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="bi bi-ticket-percent"></i> Yeni Firmaya Özel Kupon Oluştur</h4>
            </div>
            <div class="card-body">
                <form action="/sibervatanbilet/public/company/createCoupon" method="POST">
                    <div class="row">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="/sibervatanbilet/public/company/coupons" class="btn btn-secondary me-2">İptal</a>
